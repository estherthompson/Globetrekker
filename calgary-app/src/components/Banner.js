...
import './Banner.css';
import CalgaryGlanceModal from './Modals/CalgaryGlanceModal';
import DetailsModal from './Modals/DetailsModal';

// Use an array of banner images
import banner1 from '../images/image1.png'; 
import banner2 from '../images/image2.png';
        ...
        <div>
          <div className="banner-container">
            <div className="banner">
              ...
              <div className="arrow left-arrow" onClick={previousBanner}>
                &#8592;
              </div>
              <div className="arrow right-arrow" onClick={nextBanner}>
                &#8594;
              </div>
            </div>
          ...
          <CalgaryGlanceModal show={isModalOpen} onClose={closeModal}>
            <div className="modal-title-holder">
              <h2 className="modal-title">Calgary At A Glance</h2>
            </div>
  
            <div className="calgaryGlancePositioning">
              <div className="calgaryGlanceImages">
                {generalInformation.slice(0, 3).map((landmark) => (
                  <div className="calgaryGlanceImgHolder" key={landmark.name}>
                    <img
                      src={landmark.image}
                      alt={landmark.name}
                      className="calgaryGlanceImg"
                    />
                    <div className="calgaryGlanceTitleHolder">
                      <h4 className="calgaryGlanceImgTitle">{landmark.name}</h4>
                      <p className="calgaryGlanceHours">
                        Hours: {landmark.openingHours}
                      </p>
                    </div>
                    <div className="calgaryGlanceButtonHolder">
                      <button
                        className="calgaryGlanceDetailsButton"
